...
yolo-object-detection-segmentation/
│
├── Project_ObjectDetection_Segmentation.ipynb   # Notebook principal (detección + segmentación)
...
🔗 [(Coloca aquí el enlace exacto a tu dataset de placas cuando lo tengas)](https://app.roboflow.com/projectevelynsanchez/clean-yzsmx-o6xw6/1)
